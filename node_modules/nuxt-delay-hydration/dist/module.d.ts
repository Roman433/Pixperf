...
declare const NAME = "nuxt-delay-hydration";
declare const MODE_DELAY_APP_INIT = "init";
declare const MODE_DELAY_APP_MOUNT = "mount";
declare const MODE_DELAY_MANUAL = "manual";
declare const _default: _nuxt_schema.NuxtModule<ModuleOptions>;

export { type EventTypes, MODE_DELAY_APP_INIT, MODE_DELAY_APP_MOUNT, MODE_DELAY_MANUAL, type Mode, type ModuleOptions, NAME, _default as default };
