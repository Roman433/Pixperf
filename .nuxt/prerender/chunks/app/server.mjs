import { watch, reactive, version, defineComponent, computed, ref, h, resolveComponent, useSSRContext, createApp, getCurrentInstance, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, inject, toRef, shallowRef, isReadonly, defineAsyncComponent, isRef, mergeProps, nextTick, watchEffect, Suspense, Transition, withCtx, createTextVNode } from 'file:///Users/roman/Develop/corly/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/roman/Develop/corly/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/roman/Develop/corly/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/roman/Develop/corly/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/roman/Develop/corly/node_modules/@unhead/ssr/dist/index.mjs';
import { composableNames, createServerHead as createServerHead$1, getActiveHead } from 'file:///Users/roman/Develop/corly/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/roman/Develop/corly/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, RouterView } from 'file:///Users/roman/Develop/corly/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Users/roman/Develop/corly/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, parseQuery, withTrailingSlash, withoutTrailingSlash, joinURL } from 'file:///Users/roman/Develop/corly/node_modules/ufo/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/roman/Develop/corly/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderClass, ssrRenderAttr } from 'file:///Users/roman/Develop/corly/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-d4b18821.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacts-96eeb143.mjs').then((m) => m.default || m)
  },
  {
    name: "dev",
    path: "/dev",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/dev-ba805798.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8a974ce9.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/portfolio-4f0c8aa6.mjs').then((m) => m.default || m)
  },
  {
    name: "price",
    path: "/price",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/price-405af2e3.mjs').then((m) => m.default || m)
  },
  {
    name: "services",
    path: "/services",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/services-f0955ef6.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed w-full bck z-20" }, _attrs))} data-v-40b8452e><div class="text-white" data-v-40b8452e><nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center" data-v-40b8452e><div class="flex items-center justify-between" data-v-40b8452e>`);
  ...
  _push(`<div class="flex md:hidden" data-v-40b8452e><button type="button" class="text-gray-800 hover:text-gray-400 focus:outline-none focus:text-gray-400" data-v-40b8452e><div class="space-y-2" data-v-40b8452e><span class="block w-8 h-0.5 bg-white" data-v-40b8452e></span><span class="block w-5 h-0.5 bg-white" data-v-40b8452e></span></div></button></div></div><ul class="${ssrRenderClass([$data.showMenu ? "flex" : "hidden", "list flex-col mt-8 relative space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0"])}" data-v-40b8452e><li class="" data-v-40b8452e>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/services",
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "#form" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="order button button-1 text-white" data-v-40b8452e${_scopeId}> заказать </div>`);
      } else {
        return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-40b8452e"]]);
...
const _imports_0 = "" + __buildAssetsURL("phone.01bd8b29.png");
const _sfc_main$3 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-818b34b6><form data-v-818b34b6><div id="form" class="flex tad" data-v-818b34b6><div class="forma w-1/3 m-8" data-v-818b34b6><h1 class="text-volna send text-5xl mb-3" data-v-818b34b6>Оставь заявку</h1><div action="" method="POST" data-v-818b34b6><p class="text-white" data-v-818b34b6>Ваше ФИО</p><input name="name" class="inp" type="text" placeholder="введите ваше имя" data-v-818b34b6><p class="text-white" data-v-818b34b6>Ваш номер телефона</p><input name="phone" class="inp" type="text" placeholder="Ввведите номер для связи с вами" data-v-818b34b6><p class="text-white" data-v-818b34b6>Ваш email</p><input name="email" class="inp" type="email" placeholder="введите контактный email" data-v-818b34b6></div></div><div class="forma w-1/3 m-8" data-v-818b34b6><div class="sec_forma" data-v-818b34b6><div class="" data-v-818b34b6><p class="text-white" data-v-818b34b6>Ваш бюджет</p><input name="money" class="inp" type="text" placeholder="введите ваш бюджет" data-v-818b34b6><p class="text-white" data-v-818b34b6>Введите Ваш комментарий (по желанию)</p><input name="comment" class="inp" type="text" placeholder=" ваш комментарий" data-v-818b34b6><button class="button button-1 mb-3" data-v-818b34b6>отправить</button></div></div></div><div class="with-phone w-1/3 p-5" data-v-818b34b6><img class="w-full" alt="phone"${ssrRenderAttr("src", _imports_0)} data-v-818b34b6></div></div></form></div>`);
}
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-e5191265.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-e390781e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
