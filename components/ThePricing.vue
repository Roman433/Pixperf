    ...
    <div class="container px-5 py-20 mx-auto ">
      <div class="flex flex-wrap -m-5 ">
        <div class="p-4 xl:w-1/4  md:w-1/2 w-full">
          ...
          >
            <h1
              class="text-xl  text-gray-900  lg:pb-4  mt-4 mb-4 border-b font-medium leading-none"
            >
              Сайт “Каталог”
            </h1>
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          ...
          >
            <h1
              class="text-xl text-gray-900 pb-4 mt-4 mb-4 border-b font-medium leading-none"
            >
              Сайт “Визитка”
            </h1>
            <p class="flex text-sm items-center text-white mb-2">
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          ...
          >
            ...
            <p class="flex text-sm items-center text-white mb-4">
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          ...
          >
            ...
            <p class="flex text-sm items-center text-white mb-10">
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          ...
          >
            ...
            <p class="flex text-sm items-center text-white mb-2">
              Сайт на WordPress - это полноценный веб-ресурс, созданный с
              использованием популярной платформы управления контентом
              WordPress. Он предоставляет возможность создания и управления
              содержимым сайта, включая тексты, изображения, видео и другие
              медиа-элементы.
            </p>
